...
- `docs/overview/repos.md`: responsabilidades do captain-hook mencionam "publicar registro/baixa via Kafka" — atualizar pra REST; mencionar processamento paralelo de `installation` e o novo `onboard_repository` compartilhado. **Feito em 2026-09-16 — ver `docs/captain-hook-ping-install-rest`.**
